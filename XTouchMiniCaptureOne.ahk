...
{
	global statusbyte, chan, note, cc, data1, data2, data3, stb ;Make these vars global to be used in other functions
...
;EXPOSURE
    if (data1=1 and data2>=data3 and data2 !=0)
	{
		; msgbox, %data2% %data3%
		data3:=data2
		send, !{NumpadAdd}
...
;TINT
    if (data1=3 and data2>=data3 and data2 !=0)
	{
		; msgbox, %data2% %data3%
		data3:=data2
		send, !+{NumpadAdd}
    ...
    if (data1=3 and data2=0) {
		data3:=data2
		send, !+{NumpadSub}
}

;HIGHLIGHT
    if (data1=4 and data2>=data3 and data2 !=0)
	{
		; msgbox, %data2% %data3%
		data3:=data2
		send, !{NumpadDiv}
    ...
    if (data1=4 and data2=0) {
		data3:=data2
		send, !{NumpadMult}
}

;SHADOWS
    if (data1=5 and data2>=data3 and data2 !=0)
	{
		; msgbox, %data2% %data3%
		data3:=data2
		send, ^+{NumpadAdd}
    ...
    if (data1=5 and data2=0) {
		data3:=data2
		send, ^+{NumpadSub}
}

;SATURATION
    if (data1=6 and data2>=data3 and data2 !=0)
	{
		; msgbox, %data2% %data3%
		data3:=data2
		send, ^!{NumpadAdd}
...
;SHARPEN
    if (data1=7 and data2>=data3 and data2 !=0)
	{
		; msgbox, %data2% %data3%
		data3:=data2
		send, ^+{] 5}
...
;CONTRAST
    if (data1=8 and data2>=data3 and data2 !=0)
	{
		; msgbox, %data2% %data3%
		data3:=data2
		send, !{]}
